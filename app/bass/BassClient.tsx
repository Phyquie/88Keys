...
// --- DATA ---
const WHY_LEARN_BASS = [
  {
    icon: Activity,
    title: "Master Groove & Rhythm",
    description: "Lock timing with the drummer's kick and provide the rhythmic heartbeat of every band ensemble.",
  },
  {
    icon: Volume2,
    title: "Low-End Harmonic Foundation",
    description: "Connect chord harmony with deep bass frequency, directing how listeners feel musical momentum.",
  },
  {
    icon: Sparkles,
    title: "Slap & Pop Techniques",
    description: "Master explosive Funk & R&B slap bass, thumb strikes, and syncopated popping patterns.",
  },
  {
    icon: Layers,
    title: "Walking Bass & Improvisation",
    description: "Construct fluid walking basslines across Jazz standards, Funk, Rock, Blues, and Gospel progressions.",
  },
  {
    icon: Award,
    title: "High Demand in Bands",
    description: "Skilled bassists are the most sought-after musicians for band line-ups, jam sessions, and studio gigs.",
  },
  {
    icon: Brain,
    title: "Ear Training & Harmony",
    description: "Develop sharp pitch recognition, root movement awareness, and dynamic tone sculpting.",
  },
];

const WHO_CAN_JOIN = [
  { title: "Beginners", desc: "No previous instrument experience needed! Learn root note locking and clean finger plucking." },
  { title: "Upgrading Guitarists", desc: "Easily transition your fretboard knowledge into powerful bass groove architecture." },
  { title: "Teens & Young Adults", desc: "Form bands, learn classic rock & funk basslines, and prep for school stage concerts." },
  { title: "Adult Hobbyists", desc: "Stress-relieving weekend sessions learning classic Motown, Disco, and Funk basslines." },
  { title: "Band Musicians", desc: "Tighten your timing, metronome precision, and live performance stage presences." },
  { title: "Grade Candidates", desc: "Prepare for Trinity and Rockschool Bass Grade 1 through Grade 8 examinations." },
];
...
const COURSE_LEVELS = [
  {
    level: "Beginner",
    duration: "3–6 Months",
    desc: "Build rock-solid bass posture, timing precision, and root note foundations.",
    features: [
      "4-string Bass anatomy, tuning & amp setup",
      "Two-finger plucking & muting technique",
      "Root notes & octave navigation",
      "Metronome timing & 4/4 groove locking",
      "Playing 10+ famous bassline classics",
    ],
    recommendedFor: "Beginners with zero bass experience",
  },
  {
    level: "Intermediate",
    duration: "6–8 Months",
    desc: "Master slap bass, walking lines, and genre groove variations.",
    features: [
      "Slap & Pop fundamentals and ghost notes",
      "Walking basslines for Jazz & Blues",
      "Pentatonic & arpeggio fill insertions",
      "Syncopated Funk & Disco rhythms",
      "Locking tight with acoustic drum rudiments",
    ],
    recommendedFor: "Bassists with 6+ months experience",
    popular: true,
  },
  {
    level: "Advanced Groove",
    duration: "8–12+ Months",
    desc: "Explosive soloing, 5-string bass, tone EQ, and Trinity Grade 8 mastery.",
    features: [
      "5-String & Fretless bass navigation",
      "Double thumping & advanced slap solos",
      "Pre-amp tone shaping & compressor pedals",
      "Improvising over complex chord changes",
      "Rockschool & Trinity Bass Grade 8 prep",
    ],
    recommendedFor: "Advanced bassists & stage performers",
  },
];

const WHAT_YOU_WILL_LEARN = [
  { step: "01", title: "Bass Tuning & Amp Setup", desc: "Amp EQ settings, bass frequency control, and strap length." },
  { step: "02", title: "Finger Plucking & Muting", desc: "Resting thumb method and multi-finger alternating plucks." },
  { step: "03", title: "Metronome Groove Timing", desc: "Locking with the kick drum on beats 1 and 3." },
  { step: "04", title: "Reading Bass Clef & TABs", desc: "Sight-reading F clef, chord symbols, and TAB charts." },
  { step: "05", title: "Scales & Arpeggios", desc: "Major, minor, pentatonic scales, and triad inversions." },
  { step: "06", title: "Slap & Pop Technique", desc: "Thumb slap, finger pop, and rhythmic ghost notes." },
  { step: "07", title: "Walking Basslines", desc: "Harmonic chromatic approach notes for Jazz & Blues." },
  { step: "08", title: "Live Studio Band Jamming", desc: "Dynamic backing tracks, stage soloing, and certification." },
];

const CURRICULUM_MODULES = [
  {
    module: "Module 1",
    title: "Bass Anatomy, Tuning & Ergonomics",
    topics: [
      "4-String vs 5-String active/passive bass pick-ups",
      "Standard E-A-D-G tuning with bass tuners",
      "Seated and standing strap balance",
      "Left-hand thumb placement behind the neck",
    ],
  },
  {
    module: "Module 2",
    title: "Plucking Techniques & String Muting",
    topics: [
      "Alternating Index & Middle finger plucking",
      "Plectrum/pick bass technique for Rock & Punk",
      "Floating thumb string muting to stop unwanted ring",
      "Clean tone production without fret buzz",
    ],
  },
  {
    module: "Module 3",
    title: "Rhythm Locking & Metronome Timing",
    topics: [
      "Subdividing quarter notes, 8ths, and 16ths",
      "Pairing with drumkit kick and snare patterns",
      "Playing ahead, on, or behind the beat (Groove feel)",
      "Dynamic control (Soft vs explosive plucks)",
    ],
  },
  {
    module: "Module 4",
    title: "Reading Bass Clef & Fretboard Map",
    topics: [
      "Bass Clef (F Clef) note names on staff",
      "Navigating octave shapes across the neck",
      "Reading lead sheets & chord symbols",
      "Translating TABs to physical fret positions",
    ],
  },
  {
    module: "Module 5",
    title: "Scales, Arpeggios & Bass Fills",
    topics: [
      "Major & Minor Pentatonic scales across 2 octaves",
      "Root-3rd-5th-7th arpeggio structures",
      "Inserting rhythmic bass fills at section transitions",
      "Blues scales & chromatic passing tones",
    ],
  },
  {
    module: "Module 6",
    title: "Slap & Pop Technique (Funk & R&B)",
    topics: [
      "Thumb slap mechanics on low E and A strings",
      "Index finger popping on D and G strings",
      "Ghost notes and dead-string percussion",
      "Classic Funk grooves (Chic, Flea, Marcus Miller style)",
    ],
  },
  {
    module: "Module 7",
    title: "Walking Bass & Jazz Improvisation",
    topics: [
      "Constructing 4-beat walking basslines",
      "Approach notes: Chromatic, Scale, and Dominant 7th",
      "Improvising over 12-Bar Blues & Rhythm Changes",
      "Fretless bass intonation drills",
    ],
  },
  {
    module: "Module 8",
    title: "Tone Engineering & Exam Certification",
    topics: [
      "Active EQ preamp controls (Bass, Mid, Treble boost/cut)",
      "Compressor pedals & Bass DI box routing for live sound",
      "Rockschool & Trinity Bass Grade 1 to 8 exam prep",
      "Ensemble stage recital performance",
    ],
  },
];

const METHOD_STEPS = [
  { step: "01", title: "Consult / Enquiry", desc: "Schedule a 30-min consultation or enquire online or in studio." },
  { step: "02", title: "Skill Assessment", desc: "Evaluate your rhythm sense, finger strength, and current level." },
  { step: "03", title: "Choose Your Level", desc: "Select custom schedule, batch size, and groove curriculum." },
  { step: "04", title: "Weekly Groove Practice", desc: "Structured 1-on-1 and small ensemble sessions." },
  { step: "05", title: "Progress Review", desc: "Monthly feedback report and metronome accuracy tracking." },
  { step: "06", title: "Live Band Jamming", desc: "Perform with a drummer and full band in studio jam sessions." },
  { step: "07", title: "Certification", desc: "Receive official Rockschool / Trinity bass grade certification." },
];

const TEACHERS = [
  {
    name: "Marcus Vance",
    role: "Head of Bass & Production",
    exp: "12+ Years Experience",
    qualifications: "B.Mus Bass Performance (Berklee College of Music)",
    specialization: "Groove Architecture, Slap Bass, Studio DI Tones & Band Ensemble",
    bio: "Marcus is renowned for his metronomic timing and slap technique. He has recorded bass tracks for major studio albums and pop tours.",
    languages: "English, Spanish",
    achievements: "Rockschool Certified • Recorded 40+ Studio Tracks",
...
const GALLERY = [
  { id: 1, title: "Slap Bass Studio Recording Session", tag: "Studio Jam", image: "https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?q=80&w=800&auto=format&fit=crop" },
  { id: 2, title: "Band Rehearsal Drum & Bass Locking", tag: "Ensemble", image: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=800&auto=format&fit=crop" },
  { id: 3, title: "Fender Bass Tone & Amp Setup", tag: "Gear", image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=800&auto=format&fit=crop" },
  { id: 4, title: "Rockschool Bass Grade Examination", tag: "Certification", image: "https://images.unsplash.com/photo-1465847899084-d164df4dedc6?q=80&w=800&auto=format&fit=crop" },
];
...
const FAQS = [
  {
    q: "Is Bass Guitar easier to learn than 6-string guitar?",
    a: "Bass has 4 strings and plays single-note groove lines initially, making it very rewarding for beginners to learn full songs fast! However, mastering timing, slap technique, and groove requires dedication.",
  },
  {
    q: "Do I need my own bass amplifier at home?",
    a: "You can practice unplugged or use headphone bass micro-amps at home for quiet practice. We provide full Ampeg & Fender bass amp stacks in studio.",
  },
  {
    q: "Should I start with a 4-String or 5-String bass?",
    a: "We recommend starting with a 4-String bass for fundamental neck geometry and finger muting. You can transition to 5-string (Low B string) in our intermediate module.",
  },
  {
    q: "Can I join if I've never played an instrument before?",
    a: "Yes! Over 60% of our bass students are complete beginners. We teach posture, muting, timing, and note reading from step one.",
  },
  {
    q: "Do you prepare students for Rockschool Bass Exams?",
    a: "Yes. We prepare candidates for graded bass examinations from ABRSM, Trinity College London, RSL (Rockschool Ltd), and LCM (London College of Music) — from Grade 1 to Grade 8.",
  },
];
...
export default function BassClient() {
  const [teachers, setTeachers] = useState<any[]>([]);
  useEffect(() => {
    fetch("/api/teachers?department=Bass")
      .then((res) => res.ok ? res.json() : TEACHERS)
      .then((data) => setTeachers(data.length > 0 ? data : TEACHERS))
      .catch((err) => {
        console.error("Failed to load bass teachers:", err);
  ...
  return (
    <div className="relative min-h-screen bg-[#F7F2E7] text-[#17140F] font-sans selection:bg-[#17140F] selection:text-[#F7F2E7]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2.5 text-xs font-mono uppercase tracking-[0.2em] text-[#B8863B] mb-7">
                ...
                <span>Bass Guitar Architecture Program</span>
              </div>

              <h1 className="font-display text-4xl sm:text-5xl lg:text-[3.4rem] font-semibold text-[#17140F] tracking-tight leading-[1.1] mb-6">
                Become the <span className="italic gradient-text-brass">Heartbeat.</span>
                <br />
                Master the Bass.
              </h1>

              <p className="text-lg text-[#4A4335] font-normal leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-9">
                Unlock groove locking, slap technique, walking basslines, and low-end harmony to become an indispensable bassist in any musical ensemble.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8">
                ...
                >
                  ...
                  <span>Download Bass Brochure</span>
                </button>
              </div>
              ...
              {brochureDownloaded && (
                ...
                >
                  ...
                  <span>Bass Brochure PDF requested! Check your download folder.</span>
                </motion.div>
              )}
              ...
              <div className="relative mx-auto max-w-md lg:max-w-none">
                <div className="relative overflow-hidden border-4 border-[#17140F] bg-[#17140F] group">
                  <img
                    ...
                    alt="Bass Guitar studio setup at 88 Keys Studio"
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-[#F7F2E7]">
                    ...
                    <p className="text-xs text-[#B3A98F] mt-1">
                      Groove timing, slap technique, and stage tone shaping.
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-6 -left-6 glass-card p-4 shadow-xl hidden sm:flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold text-[#17140F]">Fender & Ibanez Basses</p>
                    <p className="text-[10px] text-[#4A4335] font-mono uppercase tracking-wide">4 & 5-String Studio Rigs</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-[#4A4335] text-base sm:text-lg">
              The bass is the rhythmic and harmonic backbone of every band. It unlocks groove instinct, ensemble timing, and lifelong low-end mastery.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t border-l border-[#17140F]/12">
            {WHY_LEARN_BASS.map((card, idx) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-semibold text-[#17140F] tracking-tight mb-6">
                Who Can Join Our Bass Program?
              </h2>
              <p className="text-[#4A4335] text-base leading-relaxed mb-6">
                We welcome students of all ages and backgrounds. Whether your goal is clearing Rockschool/Trinity grade exams, joining a band, or locking in with a drummer for fun, our faculty tailors the path for you.
              </p>
              ...
              <div className="p-4 border border-[#17140F]/12 bg-[#EEE5D3] flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-[#17140F]">No Previous Instrument Experience Required</p>
                  <p className="text-xs text-[#4A4335]">We teach posture, finger plucking, and groove timing from scratch.</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 md:py-32 bg-[#EEE5D3] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-semibold text-[#17140F] tracking-tight mb-4">
              Bass Guitar Course Levels
            </h2>
            <p className="text-[#4A4335] text-base sm:text-lg">
              Progressive modules designed to take you from foundational grooves to stage-ready groove mastery.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-[#F7F2E7] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-[#4A4335] text-base sm:text-lg">
              A comprehensive step-by-step groove journey designed to build mastery from day one.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-[#EEE5D3] relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-semibold text-[#17140F] tracking-tight mb-4">
              Bass Guitar Course Curriculum
            </h2>
            <p className="text-[#4A4335] text-base sm:text-lg">
              Explore the 8 core modules taught by our certified bass groove faculty.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-[#F7F2E7] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-[#4A4335] text-base sm:text-lg">
              A 7-stage systematic framework built to guarantee groove confidence and musical progress.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-[#EEE5D3] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-semibold text-[#17140F] tracking-tight mb-4">
              Meet Your Bass Mentors
            </h2>
            <p className="text-[#4A4335] text-base sm:text-lg">
              Learn directly from studio bassists and experienced groove-focused educators.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-semibold text-[#17140F] tracking-tight mb-6">
                Grades &amp; Exams: Global Bass Certification
              </h2>
              <p className="text-[#4A4335] text-base leading-relaxed mb-8">
                Beyond our in-house grade certificates, 88 Keys Music Studio prepares students for graded bass exams with four of the world&apos;s most recognized examination boards — ABRSM, Trinity College London, RSL (Rockschool Ltd), and LCM (London College of Music). Each pathway is tailored to that board&apos;s specific syllabus, so whichever route you choose, our faculty guides you from first lesson to exam day.
              </p>
              ...
              <div className="space-y-4">
                {[
                  { title: "Course Completion Certificate", desc: "Awarded upon completing Beginner, Intermediate, or Advanced Groove modules." },
                  { title: "Studio Jam Certificate", desc: "Awarded after live band ensemble recording sessions." },
                  { title: "Annual Assessment Report", desc: "Detailed breakdown of timing accuracy, tone, and technique." },
              ...
              <div className="relative p-8 bg-[#17140F] text-[#F7F2E7] border border-[#B8863B]/30">
                <div className="border-2 border-[#B8863B]/40 p-6 text-center">
                  ...
                  <h3 className="font-display text-2xl font-semibold text-[#F7F2E7] mt-4">
                    Bass Guitar Performance Grade 5
                  </h3>
                  <p className="text-xs text-[#B3A98F] italic mt-2">
                    This is to certify that the student has successfully demonstrated groove timing, slap technique, and stage performance with Distinction.
                  </p>
          ...
          <div className="relative bg-[#17140F] text-[#F7F2E7] overflow-hidden">
            <div className="relative z-10 px-8 py-16 sm:px-16 sm:py-20 text-center max-w-3xl mx-auto">
              ...
              <h2 className="font-display text-3xl sm:text-5xl font-semibold tracking-tight mb-6 leading-tight">
                Ready to Lock Your First Bass Groove?
              </h2>

              <p className="text-[#B3A98F] text-base sm:text-lg mb-9 leading-relaxed">
                Experience a 1-on-1 consultation or enquire to discover the pulse of the low end.
              </p>
      ...
      <BookingModal
        ...
        defaultCourse="Electric & Bass Guitar"
      />
