...
const FAQS = [
  ...
  },
  {
    ...
    a: "Absolutely. Book a free trial class or simply call ahead to schedule a studio tour with a faculty member.",
  },
  {
            ...
            >
              ...
              {formSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-10 py-4 bg-[#17140F] text-[#F7F2E7] font-semibold rounded-sm hover:bg-[#B8863B] hover:text-[#17140F] transition-all duration-300 inline-flex items-center justify-center gap-2 cursor-pointer"
                  >
            ...
            >
              ...
              <div className="p-6 bg-[#17140F] text-[#F7F2E7] border border-[#B8863B]/30">
                ...
                <p className="text-sm text-[#B3A98F] leading-relaxed mb-6">
                  Skip the form and book a complimentary 30-minute trial class directly — no commitment required.
                </p>
                <button
